...
$sql = "SELECT cat_num FROM t_categorie_cat WHERE cat_statu = 'E' ";
...
if ($result== false) {
	...
	$requete1 = "SELECT * FROM t_categorie_cat WHERE cat_num=".$cat_id. " AND cat_statu = 'E' ;";
  ...
  $requete="SELECT * FROM t_information_inf 
            JOIN t_categorie_cat USING(cat_num) 
            WHERE cat_num = ".$cat_id." AND cat_statu = 'E'";
