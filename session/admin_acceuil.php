  ...
  if(isset($_SESSION["login"])) {
      ...
      if ($resultUserInfo && $resultUserInfo->num_rows > 0) {
          ...
          if($userInfo["pfl_role"]=='G'){
              ...
              echo "<a class='navbar-brand' href='gestion_cat.php'>Gestion des catégories</a>";
              echo "<a class='navbar-brand' href='gest_compt.php'>Gestion des profiles</a>";
              echo "<a class='navbar-brand' href='deconnexion.php'>Déconnexion</a>";
              echo "<span class='navbar-text text-light'>";
              echo "<?php echo ucfirst(".$lhalaw."); ?>";
              echo "</span>";
              echo "</div>";
              echo "</nav>";
          }else{
